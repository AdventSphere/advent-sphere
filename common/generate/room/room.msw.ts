...
export const getGetRoomsIdResponseMock = (): Room => ({...{ownerId: faker.string.alpha({length: {min: 10, max: 20}}), itemGetTime: faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`, undefined]), password: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), isAnonymous: faker.datatype.boolean(), startAt: `${faker.date.past().toISOString().split('.')[0]}Z`},...{id: faker.string.alpha({length: {min: 10, max: 20}}), createdAt: `${faker.date.past().toISOString().split('.')[0]}Z`, generateCount: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), editId: faker.string.alpha({length: {min: 10, max: 20}})},})

export const getPatchRoomsIdResponseMock = (): Room => ({...{ownerId: faker.string.alpha({length: {min: 10, max: 20}}), itemGetTime: faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`, undefined]), password: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), isAnonymous: faker.datatype.boolean(), startAt: `${faker.date.past().toISOString().split('.')[0]}Z`},...{id: faker.string.alpha({length: {min: 10, max: 20}}), createdAt: `${faker.date.past().toISOString().split('.')[0]}Z`, generateCount: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), editId: faker.string.alpha({length: {min: 10, max: 20}})},})
